**write-up detallado de la resolución de una máquina virtual vulnerable (RetoCTF2019-2020)**

documentando el proceso completo desde la fase de reconocimiento hasta la escalada de privilegios, logrando capturar las 5 flags ocultas en el sistema
